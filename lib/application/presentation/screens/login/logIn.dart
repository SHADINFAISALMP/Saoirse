...
import 'package:epi/application/presentation/screens/HOME/HomePage.dart';
import 'package:epi/application/presentation/screens/HOME/home_screen.dart';
import 'package:epi/application/presentation/screens/PRODUCT/productpage.dart';
import 'package:epi/application/presentation/screens/bottom_navigation/Bottom_NavigationPage.dart';
import 'package:epi/application/presentation/screens/login/Forgot_Password.dart';
import 'package:epi/application/presentation/screens/login/Signup.dart';
import 'package:epi/domain/user_model/user_data.dart';
import 'package:epi/application/presentation/utils/locator/app_db.dart';
...
import '../../../../domain/core/api_endpoint.dart';
...
class _logInState extends State<logIn> {
  ...
  void showError(String message) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(title: Text("Error"), content: Text(message)),
    );
  }
              ...
              child: DecoratedBox(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    spacing: 15,
                    children: [
                      Image.asset("assets/image/google_logo.png", scale: 3),
                      Text(
                        "Sign in with Google",
                        style: TextStyle(
                          color: Colors.white,
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: const Text("OK", style: TextStyle(fontFamily: "font")),
            ),
            TextButton(
              onPressed: () {
  ...
  void _navigateToForgotPassword() {
    Navigator.push(
      ...
      ), // Replace with your actual Forgot Password screen
    );
  }
